...
export function Hero() {
  ...
  return (
    <section 
      className="relative min-h-screen flex items-center bg-portfolio-accent dark:bg-portfolio-primary/95 pt-16 overflow-hidden"
      id="home"
    >
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div 
            className={`w-full md:w-1/2 mb-12 md:mb-0 transition-all duration-1000 ${
          ...
          >
            <div className="max-w-lg mx-auto md:mx-0">
              <h1 className="text-4xl md:text-6xl font-bold text-portfolio-primary dark:text-white mb-4 leading-tight">
                Hello, I'm <br />
                <span className="text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-portfolio-primary to-portfolio-primary/70 dark:from-white dark:to-white/70">
                  Chan-Yen Hsiung
                </span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  asChild
                  className="bg-portfolio-primary hover:bg-portfolio-primary/90 text-white px-8 py-6 h-auto text-lg transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg group"
                >
                  <a href="#projects">
                    View Portfolio
                ...
                <Button
                  asChild
                  variant="outline"
                  className="border-portfolio-primary text-portfolio-primary hover:bg-portfolio-primary hover:text-white dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-portfolio-primary px-8 py-6 h-auto text-lg transition-all duration-300 hover:translate-y-[-2px] hover:shadow-md"
                >
                  <a href="#contact">
                    Contact Me
                  </a>
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              <div 
                className="absolute -bottom-6 -right-6 bg-white dark:bg-portfolio-primary p-4 rounded-lg shadow-lg animate-bounce backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90 border border-gray-100 dark:border-gray-800"
              >
